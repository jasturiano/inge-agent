...
capture concrete base and HEAD revisions. With Git, these reads help:
...
Cite location and consequence. One review pass by default. The router may select the expert for difficult review;
